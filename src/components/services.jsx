...
export default function Services({ ServicesRef }) {
  ...
  return (
    ...
    >
      ...
      <div className="col-md-8 mx-auto mb-5 mt-3">
        <h3 className="text-center" style={{ fontSize: "35px" }}>
          {translations[lang].MySkillsb}{" "}
          <span style={{ color: "#8f8f92" }}>
            {translations[lang].MySkillsb2}
          </span>
        </h3>
      </div>
      <div className="row">
        <div className="col-6  col-lg-4">
          <div
            className="card service-card  text-white  py-5  mb-3"
            style={{ border: "2px solid #202736ff", background: "#191f2b" }}
          >
            <div className="card-body">
              ...
              {/* Title */}
              <h5 className="card-title">{translations[lang].scb1}</h5>

              {/* Description */}
              <p className="card-text " style={{ color: "#8f8f92" }}>
                {translations[lang].sc1}{" "}
                <span style={{ color: "#26ade1" }}>HTML</span>,{" "}
                <span style={{ color: "#26ade1" }}>CSS</span>,{" "}
                <span style={{ color: "#26ade1" }}>JavaScript</span>
                {translations[lang].sc1_2}
              </p>
            </div>
          </div>
        </div>
        <div className="col-6  col-lg-4">
          ...
          >
            <div className="card-body">
              ...
              {/* Title */}
              <h5 className="card-title">{translations[lang].scb2}</h5>
        ...
        <div className="col-6  col-lg-4">
          ...
          >
            <div className="card-body">
              ...
              {/* Title */}
              <h5 className="card-title">{translations[lang].scb3}</h5>

              {/* Description */}
              <p className="card-text " style={{ color: "#8f8f92" }}>
                {translations[lang].sc3}{" "}
                <span style={{ color: "#26ade1" }}>RESTful APIs </span>,{" "}
                {translations[lang].sc3_2}
              </p>
            </div>
          </div>
        </div>
        <div className="col-6  col-lg-4">
          ...
          >
            <div className="card-body">
              ...
              {/* Title */}
              <h5 className="card-title">{translations[lang].scb4}</h5>
        ...
        <div className="col-6  col-lg-4">
          ...
          >
            <div className="card-body">
              ...
              {/* Title */}
              <h5 className="card-title">{translations[lang].scb5}</h5>

              {/* Description */}
              <p className="card-text " style={{ color: "#8f8f92" }}>
                {translations[lang].sc5}{" "}
                <span style={{ color: "#26ade1" }}>e-commerce platforms</span>,
                {translations[lang].sc5_2}.
              </p>
            </div>
          </div>
        </div>
        <div className="col-6  col-lg-4">
          ...
          >
            <div className="card-body">
              ...
              {/* Title */}
              <h5 className="card-title">{translations[lang].scb6}</h5>

              {/* Description */}
              <p className="card-text " style={{ color: "#8f8f92" }}>
                {translations[lang].sc6}{" "}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="col-md-8 mx-auto mb-5 mt-3">
        <a href="https://wa.me/905510590582" style={{ textDecoration: "none" }}>
          <h6 style={{ color: "#8f8f92" }} className="text-center">
